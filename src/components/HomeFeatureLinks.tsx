        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {secondaryLinks.map((item) => (
            ...
            >
              ...
              <p className="mb-6 mt-4 text-justify text-sm leading-7 text-muted">
                {item.title === "Servicios de corrección y edición" ? (
                  <>
                    Acompañamiento para manuscritos que necesitan pulir{" "}
                    <strong>estilo, estructura y coherencia narrativa</strong>.
                  </>
                ) : (
                  <>
                    Encargos visuales, <strong>personajes y piezas gráficas</strong>{" "}
                    para proyectos narrativos.
                  </>
                )}
              </p>
