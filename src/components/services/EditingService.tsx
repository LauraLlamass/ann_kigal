      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 lg:grid-cols-[1fr_0.82fr] lg:gap-16 lg:py-20">
        <div>
          ...
          <p className="mt-6 text-justify text-base leading-8 text-muted">
            Una mirada atenta para <strong>pulir tu texto sin borrar aquello que
            lo hace tuyo</strong>. La revisión se adapta a las necesidades del
            manuscrito y puede trabajar los siguientes aspectos:
          </p>
        ...
        <aside className="rounded-xl bg-clay p-7 text-paper shadow-md sm:p-8">
          ...
          <div className="mt-7 border-b border-paper/30 pb-6">
            <p className="font-serif text-5xl font-semibold text-paper">30€ ✦ A4 </p>
            <p className="mt-2 text-sm leading-6 text-paper">
              por cada 100 páginas en formato A4
            </p>
          </div>
          <div className="py-6">
            <p className="font-serif text-5xl font-semibold text-paper">15€ ✦ A5</p>
            <p className="mt-2 text-sm leading-6 text-paper">
          ...
          <p className="rounded-lg bg-paper/10 p-4 text-xs leading-6 text-paper">
            El precio definitivo se confirma después de <strong>revisar una
            muestra</strong> y puede variar según la extensión, el estado del
            texto y el tipo de intervención que necesite.
          </p>
        </aside>
      </div>
    </section>
